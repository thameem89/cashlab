...
const performanceCommissionHeading = "5. Performance Commission and Payment";
...
const performanceCommissionTerms =
  "Cash Lab provides the service on a performance-commission basis and does not charge a subscription fee. No commission is collected in advance. When commissionable realized trading profit is generated, the client retains 70% and Cash Lab receives 30% as its performance commission. If no commissionable realized trading profit is generated, no performance commission is due. The final client agreement defines calculation periods, settlement timing, eligible realized profit, loss treatment, and any exclusions.";
