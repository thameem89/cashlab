...
| -------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| `/`                  | `/`                  | Sticky header; anchors for Features, Pricing, Affiliate, FAQ; hero; performance-card marquee; three setup steps; four feature cards; AI agent mockup; market-score engine; monthly/yearly pricing; comparison table; affiliate steps; ten-item accordion; final CTA; footer | Implemented                                                |
...
- [x] Homepage section order and information hierarchy are preserved.
- [x] Navigation, mobile disclosure, anchor links, pricing toggle, FAQ accordion, and safe forms work.
...
- [ ] Cash Lab must verify every plan, price, fee, deposit, balance, profit-target, support, product-capability, affiliate, security, compatibility, wallet, withdrawal, changelog, and performance claim before publication.
